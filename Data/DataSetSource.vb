...
Public Class DataSetSource
    ...
    Private _productsAdapter As SqlDataAdapter
    ...
    Public Sub New()
        ...
        _productsAdapter = New SqlDataAdapter("Select * From Products", cn)
        Dim builder As New SqlCommandBuilder(_productsAdapter)
    ...
    Public Sub DeleteProduct(bindingSource As BindingSource, productId As Integer) Implements ISource.DeleteProduct
        ...
        Dim query = From p In table.AsEnumerable()
                    Where p.RowState <> DataRowState.Deleted AndAlso
                        p.Field(Of Integer)("ProductID") = productId
                    Select p
